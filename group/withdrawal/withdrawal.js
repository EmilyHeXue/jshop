...
Page({
  ...
  calculate (e){
    this.setData({
      poundage: e.detail.value * this.data.withdraw_fee_ratio / 100
    })
  },
  radioChange (e) {
  ...
  all_price () {
    this.setData({
      poundage: this.data.balance * this.data.withdraw_fee_ratio / 100,
      money: this.data.balance * (100 - this.data.withdraw_fee_ratio) / 100,
    })
  }
})